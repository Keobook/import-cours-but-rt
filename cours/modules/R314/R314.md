...
Elle concerne les signaux non-périodiques.

$$X(f) = \int\limits_{- \infty}^{+ \infty} x(t) \times e^{-i2 \pi f t} \times dt $$
...
- Exercice 2
    ...
    4. ...
        ...
        $x(t) = \frac{1}{2} \times \frac{2}{\pi} \times \sin(\frac{2}{\pi}t) + \frac{2}{3 \pi} \times \sin(\frac{3\pi}{2}t) + \frac{2}{5 \pi} \times \sin(\frac{5 \pi}{2} t) + ...$
