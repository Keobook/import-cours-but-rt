...
# Title: R314-TP1 Schema
# Author: Alexis Opolka
# Copyright: Alexis Opolka
# Description: Simple GNURadio diagram
...
class schema_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "R314-TP1 Schema", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("R314-TP1 Schema")
        ...
        self.settings = Qt.QSettings("GNU Radio", "schema_1")
        ...
        self._cutoff_freq_range = Range(1000, 10000, 1000, 10000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff_freq, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=schema_1, options=None):
