...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._b1_win = RangeWidget(self._b1_range, self.set_b1, "b1", "slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._b1_win)
        self._a1_range = Range(-2, 2, 0.1, 1, 200)
        self._a1_win = RangeWidget(self._a1_range, self.set_a1, "a1", "slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, Freq_fondamentale, b1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, Freq_fondamentale, a1, 0, 0)
