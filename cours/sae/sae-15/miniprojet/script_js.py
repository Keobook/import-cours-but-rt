...
bucket = "SAE-12"
org = "iut-students"
token = "Rp-fGi1msSdjAQcW7cYT0vJOEFJcOh43FhajuDd8bK2rOh9kLQMjvv_VmyJ_1jRdjPXVagScq3DY7uLFiQ2Qxw=="
...
#]
velo = ["STATION_STATUS"]
#velo = ["STATION_INFORMATION"]
j = 1

for parking in velo:
  print(f"Working on {parking}...", end=" ")
  with open(f"./csv/{parking}.CSV", "rt", encoding="utf-8") as fin:
...
### Enrichir la BD en faisant:
### - Vérification que les informations n'aient pas changé à chaque export (Vérif: 1er chunk == x chunk)
### Ajout des field:
###    - name <str>: Nom-du-parking-vélib
###    - position <tuple>: (Longitude, Lattitude) 
